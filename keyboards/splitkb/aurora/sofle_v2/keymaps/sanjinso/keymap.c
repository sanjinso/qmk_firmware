...
* |            |      |      |      |      |      |                              |      |      |      |      |      |       |
* |------------+------+------+------+------+------|                              |------+------+------+------+------+-------|
* | NEXT LYR   |   V  |   M  |   L  |   C  |   P  |                              |   X  |   F  |   O  |   U  |   J  |   ß   |
* |------------+------+------+------+------+------|                              |------+------+------+------+------+-------|
* | ESC        |   S  |   T  |   R  |   D  |   Y  |                              |   .  |   N  |   A  |   E  |   I  |   Ä   |
* |------------+------+------+------+------+------|-------.              ,-------+------+------+------+------+------|
* | RESET LYR |   Z  |   K  |   Q  |   G  |   W  |       |              |        |   B  |   H  |   Ö  |   Ü  |   ,  |   -   |
* `----------------------+------+--------+--------+-------------.  ,-------------+------+------+------+---------------------'
*                        | ____ | INVRT | MEDIA | NAVI  | MOUSE |  | SYM  | NUM    | FUNC   | ?      | ____ |
*                        |      | Escape| Enter | Space | Tab   |  | Enter| Bspace | Delete | Leader |      |
*                         `-------------------------------------'  `----------------------------------------'
...
[STRDY] = LAYOUT( 
  ...
  TO(BASE), GUI_Z, ALT_K, SHT_Q, CTL_G, DE_W,  KC_NU,                      KC_NU, DE_B,   CTL_H, SHT_OE, ALT_UE, GUI_COMMA, DE_MINS,
                        KC_NU, UC_TL1, UC_TL2, UC_TL3, UC_TL4,     UC_TR1, UC_TR2, UC_TR3, KC_LEAD, KC_TRNS
),
 ...
 */
[GAME] = LAYOUT(
    KC_0, KC_1, KC_2, KC_3, KC_4, KC_5,                                                      KC_NU, KC_NU, KC_NU, KC_NU, KC_NU, KC_NU,
 ...
 */
[GAME_2] = LAYOUT(
   KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,                                                  KC_NU, KC_NU, KC_NU, KC_NU, KC_NU, KC_NU,
